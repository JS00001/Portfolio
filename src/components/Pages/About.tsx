		...
		<Section className='py-36' id='about'>
			<div className='grid gap-24 lg:grid-cols-7'>
				<div className='col-span-4 lg:w-5/6'>
					<p className='text-lg font-medium text-gray-500'>{Content.About.subject}</p>
				...
				<div className='col-span-3 lg:p-16'>
					...
					{Content.About.socials.map((social, index) => {
						return <Social key={index} icon={social.icon} link={social.link} text={social.text} />;
					})}
				</div>
			</div>

			<div className='flex justify-center pt-32'>
				<a href='https://danielkorpai.com' className='text-gray-400 hover:text-primary'>
